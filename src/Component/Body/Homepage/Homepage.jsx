...
const SubscriberCount = () => {
	const [subscriber, setCount] = useState("0")
		   ...
		   <>
		    <div className="col-lg-1"></div>
		        <div className="col-lg-10 text-dark text-center p-5 bg-light SubscriberCountContainer">
		          ...
		          <h1 className="subscriberCount">{subscriber}</h1>
	    ...
	    >
	      ...
	      <Modal.Body>
	        ...
	        <div className="py-3" style={{display:"flex",alignItems:"center",justifyContent:"space-between"}}>
	           <input type="email" placeholder="Enter your email address" ref={email} className="form-control rounded-0"  />
